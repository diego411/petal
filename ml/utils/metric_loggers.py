...
def log_precision_recall_curve(precision_recall_curve: Metric, stage: str, log_dir: Path, current_epoch: int):
...
def log_roc_curve(roc_curve: Metric, stage: str, log_dir: Path, current_epoch: int):
