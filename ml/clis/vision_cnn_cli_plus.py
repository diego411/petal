...
from ml.models.VIsionCNNPlus import VisionCNNPlus
from ml.data.PetalDataModulePlus import PetalDataModulePlus
import wandb
import yaml
...
def cli_main() -> None:
    cli = CustomLightninCLI(
        model_class=VisionCNNPlus,
        datamodule_class=PetalDataModulePlus,
